...
public class MyBatisConfig {
    ...
    sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        /*-------------[250901 -김수헌-] TypeHandler 패키지 등록: CHAR('Y'/'N') ↔ boolean-------------
         * TypeHandler 역할 : DB에서 CHAR(1)으로 Y/N 값을 저장하고, 
         * Java DTO에서 boolean 필드로 선언도니 모든 모듈에 적용 (예시: 대표계좌 여부 Y/N 등등) */
        factoryBean.setTypeHandlersPackage("com.gym.config.type"); // 핸들러 자동 스캔
        //--------------------------------------------------------------------------------------
